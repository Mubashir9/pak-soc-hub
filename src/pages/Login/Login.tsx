        ...
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                <div className="flex justify-center">
                    <img src="/pakSocMascot.png" alt="PakSoc Mascot" className="h-24 w-24 object-contain" />
                </div>
                <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
                    Sign in to your account
                </h2>
                <p className="mt-2 text-center text-sm text-gray-600">
                    PakSoc Event Management System
                </p>
            </div>
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                ...
                >
                    <div className="mb-6">
                        <p className="text-sm text-gray-600 text-center bg-blue-50 text-blue-800 p-3 rounded-md border border-blue-100">
                            Access is restricted to authorized members only. Please use your <strong>@students.mq.edu.au</strong> email to sign in.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        >
                            {isLoading ? (
                                ...
                                <svg className="w-5 h-5 mr-3 bg-white rounded-full p-0.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
